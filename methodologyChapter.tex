...
The control architecture is organized as a ladder of configurations of increasing capability, mirroring the case structure of the characterization study \cite{Al-Rawashdeh2022_Caracterization}. Each configuration adds one mechanism on top of the previous, so that the contribution of every element to the exposure indices can be isolated experimentally in Chapter \ref{ch:experiments}.
