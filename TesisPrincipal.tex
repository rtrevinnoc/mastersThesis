...
\include{modelChapter}
\include{controlObjectivesChapter}
\include{methodologyChapter}
\include{experimentsChapter}

\include{conclusion} %adds conclusions
% ------------------------------------------------------------------------
% BIBLIOGRAPHY:
...
\include{apendice1} %chapter appendix1
% ------------------------------------------------------------------------
\end{document}
